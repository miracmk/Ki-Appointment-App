    ...
    <div className="min-h-screen bg-[#0A0B0F]">
      ...
      <div className="mx-auto max-w-7xl px-4 pb-20 pt-28 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 flex items-center gap-2 text-sm text-white/40">
          <Link href="/marketplace" className="transition hover:text-white">Consultants</Link>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    ...
                    <div className="text-right">
                      <div className="text-2xl font-bold text-white">
                        ...
                        <span className="text-base font-normal text-white/40">/hr</span>
                      </div>
                      <div className="mt-1 flex items-center justify-end gap-1.5">
                        ...
                        <span className="text-sm text-white/40">({consultant.review_count} reviews)</span>
                      </div>
                    </div>
                  </div>
            ...
            {consultant.sub_specialties.length > 0 && (
              <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] p-6 backdrop-blur-sm">
                <h2 className="mb-4 text-lg font-semibold text-white">Areas of Expertise</h2>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 rounded-2xl border border-white/[0.08] bg-white/[0.03] p-6 backdrop-blur-sm">
              <h2 className="mb-5 text-lg font-semibold text-white">Book a Session</h2>

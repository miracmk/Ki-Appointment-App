...
export const SPECIALTIES: Record<MarketplaceCategory, SpecialtyOption[]> = {
  accounting_tax: [
    { id: 'corporate_tax',        label: 'Corporate Tax Advisory',           requiresKyc: true },
    { id: 'personal_income_tax',  label: 'Personal Income Tax Consulting',   requiresKyc: true },
    { id: 'vat_indirect_tax',     label: 'VAT & Indirect Tax Advisory',      requiresKyc: true },
    { id: 'transfer_pricing',     label: 'Transfer Pricing Consulting',      requiresKyc: true },
    { id: 'intl_tax_planning',    label: 'International Tax Planning',       requiresKyc: true },
    { id: 'ma_tax',               label: 'Mergers & Acquisitions Tax',       requiresKyc: true },
    { id: 'tax_compliance',       label: 'Tax Compliance & Filing',          requiresKyc: true },
    { id: 'audit_support',        label: 'Audit Support & Preparation',      requiresKyc: true },
    { id: 'bookkeeping',          label: 'Bookkeeping & Accounting',         requiresKyc: true },
    { id: 'financial_statements', label: 'Financial Statement Preparation',  requiresKyc: true },
    { id: 'payroll_tax',          label: 'Payroll Tax Advisory',             requiresKyc: true },
    { id: 'tax_dispute',          label: 'Tax Dispute Resolution',           requiresKyc: true },
    { id: 'crypto_tax',           label: 'Cryptocurrency Tax Advisory',      requiresKyc: true },
    { id: 'real_estate_tax',      label: 'Real Estate Tax Consulting',       requiresKyc: true },
  ],
  law_corporate: [
    { id: 'contract_review',       label: 'Contract Drafting & Review',            requiresKyc: true },
    { id: 'corporate_governance',  label: 'Corporate Governance',                  requiresKyc: true },
    { id: 'ma_legal',              label: 'Mergers & Acquisitions (Legal)',         requiresKyc: true },
    { id: 'commercial_litigation', label: 'Commercial Litigation',                 requiresKyc: true },
    { id: 'employment_law',        label: 'Employment & Labor Law',                requiresKyc: true },
    { id: 'shareholder_agr',       label: 'Shareholder Agreements',               requiresKyc: true },
    { id: 'company_formation',     label: 'Company Formation & Registration',      requiresKyc: true },
    { id: 'joint_venture',         label: 'Joint Venture Agreements',             requiresKyc: true },
    { id: 'regulatory_compliance', label: 'Regulatory Compliance',                requiresKyc: true },
    { id: 'arbitration',           label: 'Dispute Resolution & Arbitration',     requiresKyc: true },
    { id: 'gdpr_data',             label: 'Data Protection & Privacy (GDPR)',      requiresKyc: true },
    { id: 'debt_recovery',         label: 'Debt Recovery & Collections',          requiresKyc: true },
    { id: 'real_estate_law',       label: 'Real Estate Law',                      requiresKyc: true },
    { id: 'startup_legal',         label: 'Startup Legal Advisory',               requiresKyc: true },
  ],
  immigration_visa: [
  ...
  financial_investment: [
    { id: 'portfolio_mgmt',       label: 'Portfolio Management Advisory',      requiresKyc: true  },
    { id: 'real_estate_inv',      label: 'Real Estate Investment Consulting',   requiresKyc: true  },
    { id: 'startup_vc',           label: 'Startup & Venture Capital Advisory',  requiresKyc: false },
    { id: 'private_equity',       label: 'Private Equity Consulting',           requiresKyc: true  },
    { id: 'forex_risk',           label: 'Forex & Currency Risk Management',    requiresKyc: true  },
    { id: 'crypto_digital',       label: 'Cryptocurrency & Digital Assets',     requiresKyc: false },
    { id: 'retirement_pension',   label: 'Retirement & Pension Planning',       requiresKyc: true  },
    { id: 'insurance_risk',       label: 'Insurance & Risk Management',         requiresKyc: true  },
    { id: 'corporate_finance',    label: 'Corporate Finance Advisory',          requiresKyc: true  },
    { id: 'fundraising_capital',  label: 'Fundraising & Capital Raising',       requiresKyc: false },
    { id: 'due_diligence',        label: 'Due Diligence Advisory',              requiresKyc: true  },
    { id: 'esg_investing',        label: 'ESG & Sustainable Investing',         requiresKyc: false },
    { id: 'wealth_management',    label: 'Wealth Management',                   requiresKyc: true  },
    { id: 'ipo_advisory',         label: 'IPO & Public Markets Advisory',       requiresKyc: true  },
    { id: 'debt_restructuring',   label: 'Debt Restructuring Advisory',         requiresKyc: true  },
  ],
  customs_trade: [
    ...
    { id: 'trade_compliance',     label: 'Trade Compliance & Regulations',              requiresKyc: true  },
    { id: 'aeo_consulting',       label: 'AEO (Authorized Economic Operator)',          requiresKyc: true  },
    ...
    { id: 'anti_dumping',         label: 'Anti-Dumping & Countervailing Duties',        requiresKyc: true  },
    { id: 'trade_finance_lc',     label: 'Letters of Credit & Trade Finance',           requiresKyc: true  },
    { id: 'supply_chain_opt',     label: 'Logistics & Supply Chain Optimization',       requiresKyc: false },
    { id: 'sanctions_compliance', label: 'Trade Sanctions Compliance',                  requiresKyc: true  },
    ...
    { id: 'customs_valuation',    label: 'Customs Valuation Disputes',                  requiresKyc: true  },
  ],
  trademark_ip: [
    { id: 'trademark_domestic',   label: 'Trademark Registration (Domestic)',          requiresKyc: true  },
    { id: 'trademark_eu',         label: 'EU Trademark Registration (EUIPO)',           requiresKyc: true  },
    { id: 'trademark_us',         label: 'US Trademark Registration (USPTO)',           requiresKyc: true  },
    { id: 'trademark_madrid',     label: 'International Trademark (Madrid System)',     requiresKyc: true  },
    { id: 'patent_filing',        label: 'Patent Filing & Advisory',                   requiresKyc: true  },
    { id: 'patent_intl_pct',      label: 'International Patent (PCT Application)',      requiresKyc: true  },
    { id: 'copyright_protection', label: 'Copyright Registration & Protection',        requiresKyc: true  },
    ...
    { id: 'ip_licensing',         label: 'IP Licensing & Agreements',                  requiresKyc: true  },
    { id: 'domain_disputes',      label: 'Domain Name Disputes (UDRP)',                requiresKyc: false },
    { id: 'ip_infringement',      label: 'Counterfeit & Infringement Actions',         requiresKyc: true  },
    { id: 'design_registration',  label: 'Industrial Design Registration',             requiresKyc: true  },
    { id: 'software_ip',          label: 'Software IP & Technology Law',               requiresKyc: true  },
  ],
};
